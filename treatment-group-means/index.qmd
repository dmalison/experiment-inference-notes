...
In the [Appendix](#sec-treatment-group-mean-regularity), we show that Assumption 3(i) implies Assumption 3(ii) for a single treatment group mean immediately.
...
## Treatment group mean regularity {#sec-treatment-group-mean-regularity}
