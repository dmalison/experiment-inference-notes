...
$\mathbf S_{dd,n}$ is positive definite for all $n\geq N$, $d\in\{0,1\}$,
and $\theta\in\Theta$.
...
=O_{\mathcal P}(1).
$$
Equation (-@eq-ratio-exact-remainder) writes each treatment-group-specific remainder as $-L_{d,n}\eta_{d,n}/(1+\eta_{d,n})$.
