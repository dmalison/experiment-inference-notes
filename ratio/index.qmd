...
$\mathbf S_{dd,n}$ is positive definite for all $n\geq n_0$, $d\in\{0,1\}$,
...
Thus (-@eq-ratio-oracle-normal-approximation),
(-@eq-ratio-reciprocal-scale-consistency), and
...
Using (-@eq-ratio-score-decomposition) and
(-@eq-ratio-feasible-remainder-bounds), we can therefore write
$$
\begin{aligned}
...
Together with (-@eq-ratio-feasible-leading-normal-approximation),
@prp-asymptotic-equivalence-perturbation implies
$$
\frac{\sqrt n(\widehat r_n-r_n)}{\widehat{\sigma}_{r,n}}
\stackrel{\mathcal P}{\approx}Z_n.
$$
...
The argument in @prp-uniform-moment-bounds(i), applied along the sequence
$\boldsymbol\theta_n$ with the Frobenius norm, and the bound
$\|\mathbf A\|\leq\|\mathbf A\|_{\mathrm F}$ therefore give
$$
\left\|
\frac{1}{n}\sum_{i=1}^n
(D_{i,d}-p_d)
...
The argument in @prp-uniform-moment-bounds(i), again applied along
$\boldsymbol\theta_n$, gives
...
The [normal approximation for treatment group means](../treatment-group-means/#eq-infeasible-scalar-normal-approximation), applied to their difference, therefore gives
$$
\frac{1}{\sqrt n\,\widetilde{\sigma}_{r,n}}
\sum_{i=1}^n X_{i,n}
\stackrel{\mathcal P}{\approx}Z_n,
...
$D_{i,d}Y_i=D_{i,d}y_{i,d}$ and $D_{i,d}Z_i=D_{i,d}z_{i,d}$, the term for treatment group $d$ in (-@eq-ratio-linearization) is exactly
$$
\frac{1}{\sqrt n\,\overline D_{d,n}}
