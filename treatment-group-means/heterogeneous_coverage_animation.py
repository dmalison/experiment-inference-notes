"""Animated GIF: CI coverage when treatment effects are highly heterogeneous."""
...
# Heterogeneous treatment effects: y_{i,1} = -y_{i,0} + 1, so Δ_i = 1 - 2 y_{i,0}
# fluctuates wildly across units even though ATE = 1.
...
out = str(Path(__file__).parent / "heterogeneous_coverage_animation.gif")
